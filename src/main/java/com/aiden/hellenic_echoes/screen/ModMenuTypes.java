...
public class ModMenuTypes {
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(ForgeRegistries.MENU_TYPES, HellenicEchoes.MODID);

    public static final RegistryObject<MenuType<AlloyForgeMenu>> ALLOY_FORGE_MENU =
            registerMenuTypes("alloy_forge_manu", AlloyForgeMenu::new);
