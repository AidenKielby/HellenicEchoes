...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        blockItem(ModBlocks.ALLOY_FORGE_BLOCK);
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = HellenicEchoes.MODID; // Change this to your mod id
    ...
    private ItemModelBuilder blockItem(RegistryObject<? extends Block> block) {
        return withExistingParent(block.getId().getPath(),
                ResourceLocation.fromNamespaceAndPath(HellenicEchoes.MODID, "block/" + block.getId().getPath()));
    }
}
